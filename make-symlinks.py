...
def main():
    ...
    bspwm_config = os.path.expanduser('~/.config/bspwm/bspwmrc')
    ...
    polybar_program_counter_py = os.path.expanduser('~/.config/polybar/program-counter.py')
    rofi_config = os.path.expanduser('~/.config/rofi/config')
    rofi_nm_config = os.path.expanduser('~/.config/networkmanager-dmenu/config.ini')
    ...
    make_symlink('bspwmrc', bspwm_config, soft=True)
    make_symlink('sxhkdrc', sxhkd_config, soft=True)
    ...
    make_symlink('program-counter.py', polybar_program_counter_py, soft=True)
    make_symlink('rofi-config', rofi_config, soft=True)
    make_symlink('networkmanager-dmenu-config', rofi_nm_config, soft=True)
